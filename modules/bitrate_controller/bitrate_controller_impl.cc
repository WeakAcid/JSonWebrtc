...
void BitrateControllerImpl::SetStartBitrate(int start_bitrate_bps) {
  {
    ...
    bandwidth_estimation_.SetSendBitrate(start_bitrate_bps, 0);
  }
  MaybeTriggerOnNetworkChanged();
}
...
//2019 infocom start
void BitrateControllerImpl::OnRLBasedBweResult(int bitrate_bps)
{
  {
    rtc::CritScope cs(&critsect_);
    bandwidth_estimation_.SetSendBitrate(bitrate_bps, 1);
  }
  MaybeTriggerOnNetworkChanged();
}
//2019 infocom end
