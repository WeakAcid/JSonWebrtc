...
class SendSideCongestionController
 ...
 private:
  ...
  int64_t last_feedback_send_time_ms_ RTC_GUARDED_BY(network_state_lock_);
  int64_t last_feedback_arrival_time_ms_ RTC_GUARDED_BY(network_state_lock_);
  //int64_t last_update_bitrate_time_ms_ RTC_GUARDED_BY(network_state_lock_);
  float last_throughput_;
